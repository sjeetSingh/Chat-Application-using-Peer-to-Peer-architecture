 ...
 */
public class NewChatRoom extends javax.swing.JFrame {

    /**
     * Creates new form NewChatRoom
     */
    App app;
    public NewChatRoom() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // send message to sever to create new room
        String message=app.name+MessageChat.dotMsg+MessageChat.CreateRoom+MessageChat.dotMsg+
                    txtRoomName.getText()+MessageChat.dotMsg+txtRoomName.getText()+MessageChat.dotMsg+txtRoomName.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewChatRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewChatRoom().setVisible(true);
            }
        });
    }
